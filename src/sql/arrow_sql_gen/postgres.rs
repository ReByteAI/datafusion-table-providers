        ...
        for (i, postgres_type) in postgres_types.iter().enumerate() {
            ...
            match *postgres_type {
                ...
                Type::JSON_ARRAY | Type::JSONB_ARRAY => build_array!(
                    get_array!(postgres_type, builder, row, i, StringBuilder, Value),
                    |v| v.to_string()
                ),
...
fn map_column_type_to_data_type(column_type: &Type, field_name: &str) -> Result<Option<DataType>> {
    match *column_type {
        ...
        Type::VARCHAR_ARRAY | Type::BPCHAR_ARRAY | Type::UUID_ARRAY => Ok(Some(DataType::List(
        ...
        Type::JSON_ARRAY | Type::JSONB_ARRAY => Ok(Some(DataType::List(Arc::new(Field::new(
            "item",
            DataType::Utf8,
            true,
        ))))),
